...
- [ ] T001 [US1] Add a self-hosted deployment operations BDD contract for profiles, smoke evidence, and recovery
- [ ] T002 [US1] Define local, development-server, and production-like deployment profiles in `docs/deployment/`
- [ ] T003 [US1] Document service boundaries, ports, volumes, secrets, storage paths, and target machines
...
- [ ] T005 [US2] Add or document one-command local startup for the selected Pydantic AI, Langfuse, and DBOS profile
- [ ] T006 [US2] Add deployment smoke command or driver for a representative selected-stack workflow
- [ ] T007 [US2] Capture repo-local deployment smoke evidence with run, trace, eval, durable, and health correlation
...
- [ ] T009 [US3] Add backup, restore, and reset runbooks for databases, service state, and run evidence
- [ ] T010 [US3] Add health, log, trace, and diagnostics runbooks for app, observability, durable runtime, and storage
